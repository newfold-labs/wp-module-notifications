# Agent guidance – wp-module-notifications

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-notifications** – A module for managing Newfold in-site notifications. Registers with the Newfold Module Loader; depends on wp-module-data and wpscholar/url. Maintained by Newfold Labs.

- **Stack:** PHP 7.3+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; provides notification management. See docs/integration.md.
