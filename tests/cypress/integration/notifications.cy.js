...
// add ai notificaiton for bluehost
if ( Cypress.env( 'pluginId' ) === 'bluehost' ) {
	notifications.push( aiNotification );
}
...
describe( 'Notifications', () => {
	...
	before( () => {
		cy.exec(
			'npx wp-env run cli wp transient delete newfold_notifications',
	...
	if ( Cypress.env( 'pluginId' ) === 'bluehost' ) {
		it( 'Test AI popup appears for the six month old sites and Close button icon is clicked', () => {
